...
from bot.database.methods.get import (
    ...
    get_count_paid_referrals  # Нужно добавить эту функцию
)
...
async def give_handler(m: Message, state: FSMContext) -> None:
    ...
    message_text = Text(
        ...
        "За каждого приглашенного друга, который оплатит подписку, ",
        "вы получите дополнительные дни VPN в подарок.\n\n",
        "📊 Ваша статистика:\n\n",
        f"👥 Всего приглашено: {count_referral_user}\n",
        f"🟢 Купили подписку: {count_paid_referrals}\n",
